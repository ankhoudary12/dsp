...
In this case, we have essentially three distinct cases:
1) Identical Twins `P(I)`
2) Twin Brothers `P(B)`
3) Fraternal Twins 'P(F)`

We want: P(I|B) = P(B|I)P(I)/P(B)

Based on Law of Total Probabilties: P(B)=P(B|I)P(I)+P(B|F)P(F)
(The complement to identical twins are fraternal twins)

We know:
P(I)=1/300
P(B|I)=1/2 (Identical twins of same sex can either be boys or girls)
P(F)=1/125
P(B|F)=1/4 (Fraternal twins can either be: BB, BG, GB, GG)

Plugging everything into original equation gives **P(I|B)= 5/11**
---

### Q6. Bayesian &amp; Frequentist Comparison  
How do frequentist and Bayesian statistics compare?

>> Frequentist statistics derives probability from long run frequency distributions. This means they postulate a large number of events and assign probabilities based on the frequency of that event happening. For example, suppose a frequentist flips a coin 1000 times. They observe 5002 heads and 4998 tails. A frequentist might say that the probability for both heads and tails is about 1/2. 

Bayesian statistics differes in that it relies on previous information to update a model or interpretation of probabilities. Concrete previous knowledge serves to update probablitites of future events. For example, in the case of coin flipping, suppose a bayesian statistician wants to know the probability of the coin landing heads. They know, from a previous trial of flipping the coin 1000 times, that heads came up 302 times. So, the bayesian statistician might say the probability is 3/10. Then, when the coin is flipped another 1000 times, heads comes up 498 times. The bayesian statistician would increment the probability somewhere between 3/10 and 1/2. They could iteratively update the probability as long as new data is being introduced into the model. 
